...
board = Board()
stage = "td"    # td = territory divide
player1 = Player("red", "Tom")
player2 = Player("blue", "Greg")
player3 = Player("yellow", "Kendall")
...
while True:
    ...
    board.pieces["egypt"].draw(screen)
    board.pieces["iran"].draw(screen)
